...
class ProbeContractTests(unittest.TestCase):
    """What being a bundled developer app means for this mod's own files."""

    @classmethod
    def setUpClass(cls):
        with open(os.path.join(ROOT, "capabilities", "mod.json"), encoding="utf-8") as f:
    ...
    def test_it_offers_its_answers_while_it_is_running_and_withdraws_them_when_it_is_not(self):
        self.assertIn("ACEUIModLoader.apps.register(me.name, surface(state));", self.js)
