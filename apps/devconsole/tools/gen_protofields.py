...
axes. The file is listed under mod.json's "files" key, so it ships but is not subject to
...
def main():
    ...
    text = (
        ...
        "   Loaded on demand by the console's .fields command; listed under mod.json \"files\". */\n"
