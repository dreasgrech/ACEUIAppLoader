/*
 * Test doubles for browser harnesses (the loader's and every mod's). Include this
 * BEFORE the library so the library's console hook wraps the capturing console.
 *
