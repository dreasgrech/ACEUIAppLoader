...
| `apps-folder.png` | 250 KB | Explorer at `Saved Games\ACE\mods` with `ACEUIModLoader.kspkg` in it, address bar visible so the path can be read. Crop to the window. |
